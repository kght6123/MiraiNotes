...
<body data-spy="scroll" data-target=".floating-2" data-offset="60" class="mw-100 w-100 mhv-100 hv-100 of-hidden d-flex flex-column">
    ...
    <nav class="sidebar bg-secondary simple always">
      <div class="sticky-top">
        <ul class="list-unstyled mt-5">
          <li>
            <a href="#" class="text-light" data-toggle="modal" data-target="#login-modal">
